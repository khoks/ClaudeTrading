---
name: state_persistence_v2
description: Internal sub-skill of master_trading_v2; called mechanically by tick.sh via persist.sh. Same persistence layer as v1 state_persistence (tick / daily / weekly snapshots, prune). Operators don't normally invoke this directly — use /master_trading_v2.
version: 0.2.0
---
