---
name: strategy_trailing_stop_v2
description: Internal sub-skill of master_trading_v2; called mechanically by tick.sh during Phase A. Same logic as v1 strategy_trailing_stop (full retracement exit on watermark-relative drop). Operators don't normally invoke this directly — use /master_trading_v2.
version: 0.1.0
---
