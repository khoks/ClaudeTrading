---
name: strategy_mean_reversion_v2
description: Internal sub-skill of master_trading_v2; called mechanically by tick.sh during Phase B. Same logic as v1 strategy_mean_reversion (cross-sectional contrarian, bottom-k laggards, 50-day MA falling-knife guard, rebuy throttle). Operators don't normally invoke this directly — use /master_trading_v2.
version: 0.1.0
---
