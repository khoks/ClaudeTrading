---
name: safe_trading_v2
description: Internal sub-skill of master_trading_v2; called mechanically by tick.sh. Same filter logic as v1 safe_trading (2-trading-day cooldown for sells / buys). Operators don't normally invoke this directly — use /master_trading_v2.
version: 0.1.0
---
